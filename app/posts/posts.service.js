    ...
    return {
        ...
        execute: function() {
            PostsService = (function () {
                ...
                PostsService.prototype.loadPost = function (filter) {
                    var url = this._url;
                ...
                PostsService.prototype.getPostCommon = function (userId) {
                    return this._http.get(this.getPostCommonUrl(userId))
                        .map(function (response) { return response.json(); });
                };
                PostsService.prototype.getPostCommonUrl = function (userId) {
